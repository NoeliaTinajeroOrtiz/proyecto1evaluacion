        ...
        <form action="../controller/registroController.php" method="POST" class="mt-2 mx-auto">
            <fieldset class="form-row reset p-4 align-items-center border border-primary ">
                ...
                <div class="form-group row g-3 mt-1 mx-auto">
                    ...
                    <div class="col-sm-10">
                        <input type="telefono" id="telefono" class="form-control text-info" name="telefono"pattern="[0-9]{9}"/>
                    </div>
                </div>
                <div class="form-group row g-3 mt-1 mx-auto">
                    <label for="dni" class="col-sm-2 col-form-label text-primary">DNI:</label>
                    <div class="col-sm-10">
                        <input type="dni" id="dni" class="form-control text-info" name="dni" pattern="[0-9]{8}[A-Za-z]{1}"/>
                    </div>
                </div>
